...
class TestRunsContinuePostContract:
    ...
    def test_post_runs_continue_returns_200_for_awaiting_input(self):
        ...
        # Continue the run
        response = self.client.post(f"/runs/{run_id}/continue", json={"action": "continue"})
    ...
    def test_post_runs_continue_nonexistent_run_returns_404(self):
        ...
        response = self.client.post("/runs/nonexistent-run-id/continue", json={"action": "continue"})
    ...
    def test_post_runs_continue_requires_action_data(self):
        ...
        response = self.client.post(f"/runs/{run_id}/continue", json={})
    ...
    def test_post_runs_continue_validates_action_format(self):
        ...
        response = self.client.post(f"/runs/{run_id}/continue", json={"action": "invalid"})
        assert response.status_code == 400
